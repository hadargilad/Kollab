  ...
  return (
    <div className="p-6 space-y-5">
      <div>
        ...
        <p className="text-zinc-300 text-sm mt-0.5">Match voice samples with known identities</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-zinc-900 border border-zinc-800 rounded-md">
            <div className="flex items-center gap-2 px-5 py-3.5 border-b border-zinc-800">
              ...
              <span className="text-zinc-200 text-xs font-mono uppercase tracking-widest">Voice Sample</span>
            </div>
            <div className="p-5">
                ...
                <div className="flex flex-col items-center">
                  ...
                  {selectedFile ? (
                    <>
                      ...
                      <p className="text-zinc-200 text-xs font-mono">{(selectedFile.size / 1024 / 1024).toFixed(2)} MB</p>
                    </>
                  ) : (
                    <>
                      <p className="text-zinc-200 text-sm mb-1">Drop voice sample here</p>
                      <p className="text-zinc-300 text-xs font-mono">MP3 · WAV · M4A</p>
                    </>
                  )}
              ...
              {selectedFile && !showResults && (
                <button onClick={handleAnalyze} disabled={isAnalyzing}
                  className="w-full py-2.5 bg-emerald-600 hover:bg-emerald-500 disabled:bg-zinc-800 disabled:text-zinc-200 text-white text-sm rounded transition-colors flex items-center justify-center gap-2">
                  {isAnalyzing ? (
          ...
          {showResults && (
            <div className="bg-zinc-900 border border-zinc-800 rounded-md">
              <div className="flex items-center justify-between px-5 py-3.5 border-b border-zinc-800">
                <span className="text-zinc-200 text-xs font-mono uppercase tracking-widest">Match Results</span>
                <span className="text-zinc-200 text-xs font-mono">{matches.length} candidates</span>
              </div>
                ...
                {matches.map((match, i) => (
                  <div key={match.id} className={`px-5 py-4 border-l-2 ${getConfidenceBorder(match.confidence)}`}>
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-zinc-200 text-xs font-mono">#{i + 1}</span>
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-zinc-200 text-[10px] font-mono uppercase tracking-wider">Confidence</div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-3">
                      {match.details.age && (
                        <div className="bg-black border border-zinc-900 rounded px-2.5 py-2">
                          <div className="text-zinc-200 text-[10px] font-mono uppercase tracking-wider mb-0.5">Age Range</div>
                          <div className="text-zinc-300 text-xs font-mono">{match.details.age}</div>
                        </div>
                      )}
                      {match.details.location && (
                        <div className="bg-black border border-zinc-900 rounded px-2.5 py-2">
                          <div className="text-zinc-200 text-[10px] font-mono uppercase tracking-wider mb-0.5">Location</div>
                          <div className="text-zinc-300 text-xs font-mono">{match.details.location}</div>
                        </div>
                      )}
                      {match.details.occupation && (
                        <div className="bg-black border border-zinc-900 rounded px-2.5 py-2">
                          <div className="text-zinc-200 text-[10px] font-mono uppercase tracking-wider mb-0.5">Occupation</div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button className="flex-1 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 text-xs rounded flex items-center justify-center gap-1.5 transition-colors">
        ...
        <div className="space-y-4">
          <div className="bg-zinc-900 border border-zinc-800 rounded-md">
            <div className="flex items-center gap-2 px-5 py-3.5 border-b border-zinc-800">
              ...
              <span className="text-zinc-200 text-xs font-mono uppercase tracking-widest">How It Works</span>
            </div>
            <div className="p-5 space-y-2 text-zinc-300 text-xs font-mono">
              {[
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-md">
            <div className="px-5 py-3.5 border-b border-zinc-800">
              <span className="text-zinc-200 text-xs font-mono uppercase tracking-widest">Confidence Levels</span>
            </div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-md">
            <div className="px-5 py-3.5 border-b border-zinc-800">
              <span className="text-zinc-200 text-xs font-mono uppercase tracking-widest">Database Stats</span>
            </div>
